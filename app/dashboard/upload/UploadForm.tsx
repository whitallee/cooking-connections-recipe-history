...
import { extractFromCard, saveRecipe } from './actions'
...
export default function UploadForm() {
  ...
  async function handleExtract() {
    ...
    const result = await extractFromCard(fd)
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    fd.append('recipe_date', recipeDate)
    ...
    <form onSubmit={handleSubmit} className="flex flex-col gap-6">
      ...
      <section className="rounded-lg border border-zinc-200 bg-white p-5">
        ...
        <PhotoInput
          id="card-upload"
          label=""
          hint="JPEG, PNG, WebP, or HEIC — max 10 MB"
          preview={cardPreview}
        ...
        {cardFile && !extracted && (
          <div className="mt-3 flex items-center gap-3">
            ...
            >
              {isExtracting ? 'Extracting…' : 'Extract from card'}
            </button>
            <button
              type="button"
              onClick={() => {
        ...
        {extracted && (
          <p className="mt-3 flex items-center gap-1.5 text-sm text-green-700">
            ...
            Extracted — review the fields below and make any corrections.
          </p>
        )}
      ...
      <section className="rounded-lg border border-zinc-200 bg-white p-5">
        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="servings" className="text-sm font-medium text-zinc-700">
                Servings
              </label>
              <input
                id="servings"
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
            <div className="flex flex-col gap-1">
              <label htmlFor="prep_time" className="text-sm font-medium text-zinc-700">
                Prep time
              </label>
              <input
                id="prep_time"
            ...
            <div className="flex flex-col gap-1">
              <label htmlFor="cook_time" className="text-sm font-medium text-zinc-700">
                Cook time
              </label>
              <input
                id="cook_time"
      ...
      <section className="rounded-lg border border-zinc-200 bg-white p-5">
        ...
        <div className="flex flex-col gap-2">
          <div className="grid grid-cols-[80px_100px_1fr_32px] gap-2 text-xs font-medium text-zinc-500 px-1">
            <span>Qty</span>
            <span>Unit</span>
          ...
          {ingredients.map((ing, i) => (
            <div key={i} className="grid grid-cols-[80px_100px_1fr_32px] gap-2 items-center">
              <input
                type="text"
                value={ing.quantity}
      ...
      <section className="rounded-lg border border-zinc-200 bg-white p-5">
        ...
        <p className="mb-4 text-sm text-zinc-500">
          A photo of the finished dish — shown as a thumbnail when customers browse
          recipes.
        </p>
        <PhotoInput
          id="food-upload"
      ...
      <button
        type="submit"
        disabled={isSaving}
        className="self-start rounded-lg bg-zinc-900 px-6 py-2.5 text-sm font-medium text-white hover:bg-zinc-700 transition-colors disabled:opacity-50"
      >
